...
export const OLLAMA_MID_MODELS = ["deepseek-v3.2"] as const;
...
export const OLLAMA_LOW_MODELS = ["qwen3.5:397b"] as const;

export const DEFAULT_MAIN_MODEL = "qwen3-coder:480b";
export const DEFAULT_TITLE_MODEL = "qwen3.5:397b";
export const DEFAULT_TABULAR_MODEL = "deepseek-v3.2";
